...
const OBS_FS = {
  home: {
    "README.txt": "OBSIDIAN OS v1.0.0\nImperial Security Network — Access by clearance only.\nType 'help' for commands.\nType 'doctrine' for the Obsidian Doctrine.",
    "doctrine.txt": "THE OBSIDIAN DOCTRINE\n\nI. Information before action. Every strike is guided by intelligence.\nII. The net is permanent. Patrols rotate; the hunt does not.\nIII. Every citizen is a sensor. Propaganda trains them; fear keeps them reporting.\nIV. Mercy is a tactic, not a value. Grant it only when it serves the hunt.\nV. The hunt ends only when the last ember is cold.",
    "targets.log": "╔══════════════════════════════════════════════╗\n║         JEDI ELIMINATION LOG v6.6          ║\n╠════════════════════════════════════════════╣\n║  Kade.exe        → HUNTING    [TORVANE]   ║\n║  Voss.exe        → HUNTING    [MYRRAH]    ║\n║  Nyx.exe         → HUNTING    [KESS]      ║\n║  Vale.exe        → TRACKED    [OSTRAK]    ║\n║  Elluin.exe      → SEARCHING  [VELAROS]   ║\n║  Rook.exe        → TERMINATED [HEARTH]    ║\n║  Merrik.exe      → HUNTING    [DORN]      ║\n║  Thorne.exe      → WATCHING   [BELLHAVEN] ║\n║  Varro.exe       → SEARCHING  [NYXARIS]   ║\n╠════════════════════════════════════════════╣\n║  ALL THREATS REMAIN ACTIVE. HUNT CONTINUES.║\n╚══════════════════════════════════════════════╝",
    sectors: { "torvane.txt": "SECTOR TORVANE — STATUS: HOT\nGarrison: 12TH LEGION\nThreat Index: 92/100\nIntel: Jedi activity confirmed. Urban sprawl provides ideal cover. Sector sealed at checkpoints 4-9.", "myrrah.txt": "SECTOR MYRRAH — STATUS: HOT\nGarrison: 7TH LEGION\nThreat Index: 84/100\nIntel: Trade route nexus. Recruit smuggling suspected through dock district.", "kess.txt": "SECTOR KESS — STATUS: HOT\nGarrison: 2ND LEGION\nThreat Index: 79/100\nIntel: Moon of Ostrak. Dense shadow-side settlements.", "dorn.txt": "SECTOR DORN — STATUS: CLEAN\nGarrison: 22ND LEGION\nThreat Index: 18/100\nIntel: Fortress world. Loyalist population." },
    dossiers: { "kade.txt": "SOLENNE KADE — THE EMBER\nThreat: EXTREME · Reward: 500,000\nAbilities: Thermal projection, blade ignition, berserk states.\nLast seen: TORVANE — 6 days ago.\nNotes: Will fight to the death. Approach with heavy support.", "nyx.txt": "SERAPHINE NYX — THE SHADE\nThreat: HIGH · Reward: 500,000\nAbilities: Shadow melding, silent movement, fear projection.\nLast seen: KESS — 2 days ago.\nNotes: Killed two Inquisitors. Do not engage solo.", "voss.txt": "DRAYVEN VOSS — THE UNBROKEN\nThreat: HIGH · Reward: 350,000\nAbilities: Battle meditation, deflection mastery.\nLast seen: MYRRAH — 12 days ago.\nNotes: His capture would be a propaganda victory." },
    ops: { "iron-harvest.txt": "OP: IRON HARVEST — ACTIVE\nTarget: Solenne Kade · Sector: Torvane\nSquad: 1ST INQUISITORIAL · Priority: 1\nStalking protocol active. Awaiting Inquisitor Vex.", "nightglass.txt": "OP: NIGHTGLASS — ACTIVE\nTarget: Seraphine Nyx · Sector: Kess\nSquad: ISB SHADOW CELL · Priority: 1\nTriangulating second safehouse.", "red-harbor.txt": "OP: RED HARBOR — ACTIVE\nTarget: Cassian Merrik · Sector: Dorn\nSquad: PURGE COMMANDO · Priority: 1\nCell located. Strike imminent." }
  }
};

/* ── FOUNDERS (terminal files) ────────────────────────── */
if (OBS_FS.home) {
  OBS_FS.home.founders = {
    "anuj.txt": "ANUJ PHULERA // ID: 001\nRole: DEVELOPER · AI · BACKEND\n\nThe builder. Architects the engine that powers OBSIDIAN —\nfrom zero-latency backend systems to the AI models that\nmake the hunt computable.\n\nHe writes the code that makes the Empire operational.",
    "aarav.txt": "AARAV CHOUDHARY // ID: 002\nRole: VISION · MARKETING · IDEAS\n\nThe strategist. Saw the decay of the old order and decided\nto burn it down by imagining something absolute.\n\nHe engineers the narrative. Refuses to compromise on the idea.",
    "jeehaan.txt": "JEEHAAN KWATRA // ID: 003\nRole: DESIGN · MEDIA · PITCH\n\nThe image-maker. Forges the Empire's aesthetic — every pixel,\nevery frame, every blade of the sigil.\n\nHe makes the hunt look inevitable.",
  };
}

/* ── ESM exports ──────────────────────────────────────── */
export { OBS, SECTORS, TARGETS, INQUISITORS, OP_NAMES, SQUADS, INTEL_TEMPLATES, INTEL_CONF, PROP_TEMPLATES, PROP_SLOGANS, DOCS, TICKER_LINES, SEED_SIGHTINGS, SEED_INTEL, SEED_OPS, SEED_BROADCASTS, OBS_FS, R, Store, loadStore, saveStore };
